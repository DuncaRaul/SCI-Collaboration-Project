        ...
        <div class="main">
            <ul class="service_list">
                <li>
                    ...
                    <p class="para">The lobby, the restaurant and every room is covered by Wi-Fi internet so you won't have to worry about not responding to important messages. </p>
