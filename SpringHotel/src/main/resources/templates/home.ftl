				  ...
				  <div class="reservation">
					  <ul>
						 <li  class="span1_of_1 left">
							 ...
							 <div class="book_date">
								 <form>
								 <input class="date" id="datepicker" type="text" value="1/01/2018" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '1/01/2018';}">
								 </form>
							 </div>
						 </li>
						 <li  class="span1_of_1 left">
							 ...
							 <div class="book_date">
							 <form>
								<input class="date" id="datepicker1" type="text" value="31/01/2018" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '31/01/2018';}">
							 </form>
						     </div>
						 </li>
						 <li class="span1_of_1">
							 ...
							 <div class="section_room">
							      <select id="country" onchange="change_country(this.value)" class="frm-field required">
										...
										<option value="AX">Penthouse</option>
							      </select>
							 </div>
						 </li>
						 <li class="span1_of_3">
...
<div class="package text-center">
	 <div class="container">
		 <h3>Book A Room</h3>
		 <p>Spring Hotel was designed in such a way that it suits anyone's needs. From single rooms to a penthouse, we guarantee that you will not regret
	 ...
	 <div class="container">
		 ...
		 <div class="room-grids">
			 <div class="col-md-4 room-sec">
				 ...
				 <h4>Single Room</h4>
				 <p>This type of room is recommended for 1 or 2 people. The room is packed with everything you need for you to leave your
			 ...
			 <div class="col-md-4 room-sec">
				 ...
				 <h4>Apartment</h4>
				 <p>This type of room is typically recommended for a family or for a small group of people (3-8 people). It is packed with everything the single room has to offer,
			 ...
			 <div class="col-md-4 room-sec">
				 ...
				 <h4>Penthouse</h4>
				 <p>Spring Hotel's penthouse is for the party lovers. We have covered you with state of the art electronics and amazing room design for you and
...
<div class="fotter">
	 <div class="container">
		 ...
		 <h4>"Biscuitii sunt biscuiti pentru ca nu sunt jeleuri" - John Deo, 2014</h4>
		 <i class="man"></i>
	 </div>
</div>
<!---->
	  ...
	  <div class="container">
	      <div class="col-md-5 details">
			 <div class="hotel-info">
				 ...
				 <p>Set on the shores of the Spring beaches in Spring, Spring country's economic capital, Spring hotel gives you a warm welcome. Renovated, modern rooms and a restaurant serving a wide range of mouthwatering dishes, snacks, and refreshments. </p>
				 <p>The hotel offers plenty of opportunities to relax, have fun and to put your everyday worries aside during your stay.</p>
			 </div>
			 <div class="news">
				 <h4>LATEST NEWS</h4>
